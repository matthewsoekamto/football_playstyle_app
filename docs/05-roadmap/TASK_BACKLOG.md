...
- **Review gate (owner decision pending):** first `--evaluate` flagged GK (18/28 "Mixed Profile") — root-caused as a genuinely quiet GK cluster, not a calibration failure; see the plan deviation note in the commit/changelog.
